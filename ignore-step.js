...
if (VERCEL_GIT_PULL_REQUEST === "1" && 
    (VERCEL_GIT_PULL_REQUEST_TARGET_BRANCH === "main" || VERCEL_GIT_PULL_REQUEST_TARGET_BRANCH === "dev")) {
  console.log(`Building and deploying for PR targeting: ${VERCEL_GIT_PULL_REQUEST_TARGET_BRANCH}`);
